...
#' for two independent underreported count samples using JAGS. Model selection
...
urc_two_mcmc <- function(x,
  ...
  parameters_poisson <- c("lambda1", "lambda2", "rates_ratio", "p1", "p2", "loglik")
  parameters_zip <- c("lambda1", "lambda2", "rates_ratio", "p1", "p2", "pi1", "pi2", "loglik")
  parameters_nb <- c("lambda1", "lambda2", "rates_ratio", "p1", "p2", "c1", "c2", "loglik")
